...
public class FirstReportDetailsAdapter extends RecyclerView.Adapter<FirstReportDetailsAdapter.MyViewHolder> {
    private static final String TAG = "FirstReportDetailsAdapt";
    CommonCodeManager commonCodeManager;
    private Context context;
    private int selectedPosition;
    private List<FleetListModel> fleetListModelList;

    public FirstReportDetailsAdapter(Context context, List<FleetListModel> fleetListModelList) {
    ...
    public FirstReportDetailsAdapter() {
    }

    @NonNull
    @Override
    public FirstReportDetailsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_row_report1_details, parent, false);

        return new FirstReportDetailsAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final FirstReportDetailsAdapter.MyViewHolder holder, final int position) {
