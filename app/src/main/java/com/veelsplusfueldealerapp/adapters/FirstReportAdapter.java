...
public class FirstReportAdapter extends RecyclerView.Adapter<FirstReportAdapter.MyViewHolder> {
    private static final String TAG = "FirstReportAdapter";
    CommonCodeManager commonCodeManager;
    private Context context;
    private int selectedPosition;
    private List<FleetListModel> fleetListModelList;

    public FirstReportAdapter(Context context, List<FleetListModel> fleetListModelList) {
    ...
    public FirstReportAdapter() {
    }

    @NonNull
    @Override
    public FirstReportAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_row_first_report, parent, false);

        return new FirstReportAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final FirstReportAdapter.MyViewHolder holder, final int position) {
