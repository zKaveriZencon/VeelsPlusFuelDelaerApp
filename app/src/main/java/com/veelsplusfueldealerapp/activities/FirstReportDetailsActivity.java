...
import com.veelsplusfueldealerapp.adapters.FirstReportDetailsAdapter;
...
public class FirstReportDetailsActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "FirstReportDetailsActiv";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_first_report_details);
    }
    private void initUI() {

        commonTaskManager = new CommonTaskManager(FirstReportDetailsActivity.this);
        commonCodeManager = new CommonCodeManager(FirstReportDetailsActivity.this);

        recyclerViewReport1 = findViewById(R.id.recyclerview_report1_details);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.imageview_back_arrow:
                Intent intent = new Intent(FirstReportDetailsActivity.this, ReportFirstActivity.class);
    ...
    private void fillReportCardsData(List<FleetListModel> fleetList) {
        FirstReportDetailsAdapter firstReportAdapter = new FirstReportDetailsAdapter(FirstReportDetailsActivity.this, fleetList);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(FirstReportDetailsActivity.this);
